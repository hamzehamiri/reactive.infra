...
export default class BaseSVGComponent extends BaseSharedComponent {
    ...
    onAttach(parentElement, appenderFunction) {
        ...
        if (!this.isAttached) {
            if (this.getParent()) {
                if (this.getParent() instanceof BaseSVGComponent || this.getParent() instanceof BaseHTMLComponent) {
