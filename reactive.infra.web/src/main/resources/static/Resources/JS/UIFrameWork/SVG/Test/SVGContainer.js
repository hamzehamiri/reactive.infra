...
export class SVGContainer {
    constructor() {
        ...
        this.svgElement.setAttributeNS(null, "view-box", "0 0 800 600");
        this.svgElement.setAttributeNS(null, "width", "800");
        this.svgElement.setAttributeNS(null, "height", "600");
        ...
        this.cube = new Cube3D(this.center, dy);
        this.cube.render(this.svgElement, dx, dy);
        ...
        this.svgElement.addEventListener('mousemove', (e) => {
            if (that.mouse.down) {
                ...
                for (let i = 0, ii = 8; i < ii; i++) {
                    that.Rotate(that.cube.vertices[i], that.center, theta, phi);
                }

                that.mouse.x = e.clientX;
                that.mouse.y = e.clientY;

                that.cube.render(that.svgElement, dx, dy);
            }
        });
