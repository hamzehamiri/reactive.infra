...
export default class ListPlugButton extends BaseButtonEditor {
    ...
    onMouseClick(event) {
        ...
        if (this.arrowElement.contains(event.target)) {
            ...
            this.CommandCustomConsumer(ListPlugButton.clientUiKey(), this, new ButtonEditorEvent(this, ListPlugButton.clientUiKey()));
