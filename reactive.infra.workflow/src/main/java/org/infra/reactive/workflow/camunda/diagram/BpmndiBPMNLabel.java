...
@WorkflowNodeReaderRegistry(registerKey = CamundaConstantXmlTag.bpmndiBPMNLabel, workFlowType = WorkflowNodeReaderEngineEnum.Camunda)
public class BpmndiBPMNLabel extends AbstractWorkFlowScanChildNode {
    public BpmndiBPMNLabel(AbstractWorkFlowScanChildNode parent, Node node) {
        super(parent, node);
    }
}
