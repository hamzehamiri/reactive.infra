...
@WorkflowNodeReaderRegistry(registerKey = CamundaConstantXmlTag.bpmnOutgoing, workFlowType = WorkflowNodeReaderEngineEnum.Camunda)
public class BpmnOutgoingNodeModel extends AbstractWorkFlowScanChildNode {

    @Getter
    private String id;

    public BpmnOutgoingNodeModel(AbstractWorkFlowScanChildNode parent, Node node) {
        super(parent, node);
    }
    ...
    protected void scanChildes() {
        ...
        fireEvent(BpmnEventCommand.outComingNode, bpmnJoinEvent);
    }
