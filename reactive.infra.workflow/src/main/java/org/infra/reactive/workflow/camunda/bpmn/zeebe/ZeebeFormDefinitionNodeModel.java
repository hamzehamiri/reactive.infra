...
@WorkflowNodeReaderRegistry(registerKey = CamundaConstantXmlTag.zeebeFormDefinition, workFlowType = WorkflowNodeReaderEngineEnum.Camunda)
public class ZeebeFormDefinitionNodeModel extends AbstractWorkFlowScanChildNode {

    public ZeebeFormDefinitionNodeModel(AbstractWorkFlowScanChildNode parent, Node node) {
        super(parent, node);
    }
    ...
    public void internalSignal(WorkFlowContext workFlowContext, BpmnProcessNodeModel bpmnProcessNodeModel) throws WorkFlowException {
        ...
        System.out.println(" Form Signal ");
    }

    public String getId() {
        return attributeMap.get(CamundaConstantXmlTagAttributes.formId);
    }
}
