...
@WorkflowNodeReaderRegistry(registerKey = CamundaConstantXmlTag.bpmndiBPMNEdge, workFlowType = WorkflowNodeReaderEngineEnum.Camunda)
public class BpmndiBPMNEdge extends AbstractWorkFlowScanChildNode {
    public BpmndiBPMNEdge(AbstractWorkFlowScanChildNode parent, Node node) {
        super(parent, node);
    }
}
