...
@WorkflowNodeReaderRegistry(registerKey = CamundaConstantXmlTag.bpmnExtensionElements, workFlowType = WorkflowNodeReaderEngineEnum.Camunda)
public class BpmnExtensionElementsNodeModel extends AbstractWorkFlowScanChildNode {

    public BpmnExtensionElementsNodeModel(AbstractWorkFlowScanChildNode parent, Node node) {
        super(parent, node);
    }
}
