...
public enum ERPHttpStatus {
    ...
    private static final ERPHttpStatus[] VALUES;
    ...
    ERPHttpStatus(int value, Series series, String reasonPhrase) {
        this.value = value;
        this.series = series;
    ...
    public static ERPHttpStatus valueOf(int statusCode) {
        ERPHttpStatus status = resolve(statusCode);
        if (status == null) {
    ...
    public static ERPHttpStatus resolve(int statusCode) {
        for (ERPHttpStatus status : VALUES) {
