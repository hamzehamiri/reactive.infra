...
@Data
@CoreTableDefinition(tableName = "core_table_column_dataprovider_list")
public class CoreTableColumnDataProviderListEntity implements BaseEntityInterface<Long> {
