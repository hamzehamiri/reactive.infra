...
@CoreFilterOperationJavaServiceRegistry(registerKey = OperatorConstant.string_like)
public class CoreFilterOperation_StringLike extends CoreFilterOperationAbstract {
    @Override
    public void applyFilter(ColumnsCriteriaComparisonOperatorModel.ColumnsCriteriaComparisonOperatorModelBuilder columnsCriteriaComparisonOperatorModelBuilder) {
        generateFilter(columnsCriteriaComparisonOperatorModelBuilder, ComparisonOperators.string_like);
    }
}
