...
@Data
@CoreTableDefinition(tableName = "core_workflow_action")
public class CoreWorkflowActionEntity implements BaseEntityInterface<Long> {
    ...
    private String name;
    @CoreColumnDefinition(columnName = "core_workflow_action_type_id", columnType = CoreColumnType.INT64)
    private Long core_workflow_action_type_id;
