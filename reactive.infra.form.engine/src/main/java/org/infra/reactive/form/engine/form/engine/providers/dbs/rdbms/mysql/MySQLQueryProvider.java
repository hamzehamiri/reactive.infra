...
public class MySQLQueryProvider extends AbstractRDBMSQueryProvider {

    public MySQLQueryProvider(MySQLQueryProvider parentPostgresQueryProvider, RDBMSAliasProvider rdbmsAliasProvider) {
