...
@Data
@CoreTableDefinition(tableName = "core_dashboard_view")
public class CoreDashboardViewEntity implements BaseEntityInterface<Long> {
    ...
    @CoreColumnDefinition(columnName = "core_dashboard_view_parent_id", columnType = CoreColumnType.INT64)
    private Long core_dashboard_view_parent_id;
    @CoreColumnDefinition(columnName = "layout_json", columnType = CoreColumnType.String)
