...
@Data
@CoreTableDefinition(tableName = "core_tenant")
public class CoreTenantEntity implements BaseEntityInterface<Long> {
    @CoreColumnDefinition(columnName = "id", columnType = CoreColumnType.INT64, isPk = true, sequenceName = "core_tenant_metadata_id_seq")
    private Long id;
    @CoreColumnDefinition(columnName = "name", columnType = CoreColumnType.String)
    private String name;
    @CoreColumnDefinition(columnName = "core_tenant_type_id", columnType = CoreColumnType.INT64)
    private Long core_tenant_type_id;
