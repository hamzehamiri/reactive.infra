...
@Data
@CoreTableDefinition(tableName = "core_wizard")
public class CoreWizardEntity implements BaseEntityInterface<Long> {
    @CoreColumnDefinition(columnName = "id", columnType = CoreColumnType.INT64, isPk = true, sequenceName = "core_wizard_id_seq")
    private Long id;
