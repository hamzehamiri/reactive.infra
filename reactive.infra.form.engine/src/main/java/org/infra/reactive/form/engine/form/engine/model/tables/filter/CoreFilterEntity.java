...
@Data
@CoreTableDefinition(tableName = "core_filter")
public class CoreFilterEntity implements BaseEntityInterface<Long> {
    ...
    private String name;
    @CoreColumnDefinition(columnName = "core_filter_parent_id", columnType = CoreColumnType.INT64)
    private Long core_filter_parent_id;
}
