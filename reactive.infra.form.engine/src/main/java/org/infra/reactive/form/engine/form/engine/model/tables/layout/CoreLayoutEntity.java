...
@Data
@CoreTableDefinition(tableName = "core_layout")
public class CoreLayoutEntity implements BaseEntityInterface<Long> {
    @CoreColumnDefinition(columnName = "id", columnType = CoreColumnType.INT64, isPk = true, sequenceName = "core_layout_id")
    private Long id;
