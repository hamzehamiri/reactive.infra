...
@Data
@CoreTableDefinition(tableName = "core_table_column_editor")
public class CoreTableColumnEditorEntity implements BaseEntityInterface<Long> {
    ...
    private String name;
    @CoreColumnDefinition(columnName = "editor_class_register_key", columnType = CoreColumnType.String)
    private String editor_class_register_key;
}
