...
@Data
@CoreTableDefinition(tableName = "core_table_column_dataprovider_tree")
public class CoreTableColumnDataProviderTreeEntity implements BaseEntityInterface<Long> {
