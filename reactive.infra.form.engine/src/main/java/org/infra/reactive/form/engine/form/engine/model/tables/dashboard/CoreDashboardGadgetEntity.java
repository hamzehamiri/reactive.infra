...
@Data
@CoreTableDefinition(tableName = "core_dashboard_gadget")
public class CoreDashboardGadgetEntity implements BaseEntityInterface<Long> {
    ...
    @CoreColumnDefinition(columnName = "core_dashboard_item_id", columnType = CoreColumnType.INT64)
    private Long core_dashboard_item_id;
}
