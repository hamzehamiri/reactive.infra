package org.infra.reactive.form.engine.registery.ver1;
...
public class WinRegistryOld {
    ...
    public static void main(String[] args) throws InvocationTargetException, IllegalAccessException {
        String value = WinRegistryOld.readString(
                WinRegistryOld.HKEY_LOCAL_MACHINE,                             //HKEY
