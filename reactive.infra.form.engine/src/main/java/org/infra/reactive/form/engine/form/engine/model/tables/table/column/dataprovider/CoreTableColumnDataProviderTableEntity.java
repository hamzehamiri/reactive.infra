...
@Data
@CoreTableDefinition(tableName = "core_table_column_dataprovider_table")
public class CoreTableColumnDataProviderTableEntity implements BaseEntityInterface<Long> {
