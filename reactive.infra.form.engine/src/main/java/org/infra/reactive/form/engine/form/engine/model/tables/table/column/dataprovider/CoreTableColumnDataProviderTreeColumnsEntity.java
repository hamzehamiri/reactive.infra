...
public class CoreTableColumnDataProviderTreeColumnsEntity implements BaseEntityInterface<Long> {
    @CoreColumnDefinition(columnName = "id", columnType = CoreColumnType.INT64, isPk = true)
    private Long id;
    @CoreColumnDefinition(columnName = "core_table_column_dataprovider_tree_id", columnType = CoreColumnType.INT64)
    private Long core_table_column_dataprovider_tree_id;
