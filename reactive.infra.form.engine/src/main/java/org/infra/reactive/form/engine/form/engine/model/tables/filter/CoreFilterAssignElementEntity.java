...
@Data
@CoreTableDefinition(tableName = "core_filter_assign_element")
public class CoreFilterAssignElementEntity implements BaseEntityInterface<Long> {
    @CoreColumnDefinition(columnName = "id", columnType = CoreColumnType.INT64, isPk = true, sequenceName = "core_filter_assign_element_id")
    private Long id;
